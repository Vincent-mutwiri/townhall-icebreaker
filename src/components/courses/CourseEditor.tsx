...
import { ArrowLeft, Save, Plus, FileText, HelpCircle, Image, Video, ClipboardList, Trash2, Upload, Loader2 } from "lucide-react";
                        ...
                        <AccordionContent className="pt-4">
                          <div className="space-y-4">
                            ...
                            {module.type === 'image' && (
                              <ImageModuleEditor
                                module={module}
                                onChange={(updates) => updateModule(index, updates)}
                              />
                            )}
